...
export default function RadarEditor({ initialSvg }: { initialSvg?: string }) {
  ...
  function preset(id: string) {
    ...
    setPresentation((v) => ({ ...v, subtitle: example.subtitle, source: example.source }));
    setActive(id);
    emitUsage('radar-chart', 'sample');
  }
  ...
  useEffect(() => {
    ...
    if (radarPresets.some((p) => p.id === id)) preset(id!);
  }, []);
  return (
      ...
      <div className="workspace-body radar-workspace">
        ...
        <div className="canvas-panel">
          ...
          <div className="canvas-bottom">
            ...
            <button
              className="text-button"
              onClick={() => download(csv(table), 'text/csv;charset=utf-8', 'radar-chart-data.csv')}
            >
